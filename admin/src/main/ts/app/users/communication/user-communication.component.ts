    ...
    template: `
        ...
        <panel-section section-title="user.communication.section.title.sending-rules" [folded]="false">
            ...
            <div class="user-communication__content">
                <communication-rules [sendingHeaderLabel]="'user.communication.groups-of-user' | translate" [receivingHeaderLabel]="'user.communication.groups-that-user-can-communicate-with' | translate" [communicationRules]="userSendingCommunicationRules"></communication-rules>
            </div>
        </panel-section>
        ...
        <panel-section section-title="user.communication.section.title.receiving-rules" [folded]="false">
            ...
            <div class="user-communication__content">
                <communication-rules [sendingHeaderLabel]="'user.communication.groups-that-can-communicate-with-user' | translate" [receivingHeaderLabel]="'user.communication.groups-of-user' | translate" [communicationRules]="userReceivingCommunicationRules"></communication-rules>
            </div>
        </panel-section>`,
    styles: [`
        .button.button--back {
